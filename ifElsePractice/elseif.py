...
# Run to the grocery store. Nesting if, elif, else statements
response = "yes"
...
if demand > 4:
	...
	correct = raw_input("Was Jesus suppose to buy 4?\t")				# Must prompt another code for the user to help him out tut thus starting a new if statement within an if statement.
...
#But if the user input is less than 4 then this code will run. 
	...
	correct = raw_input("Did jesus have to buy 4?\t")				# Same method as shown above
	if correct.lower() == response.lower():
